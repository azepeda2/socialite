...
import 'package:social_media/screens/nav/cubit/bottom_nav_bar_cubit.dart';
import 'package:social_media/screens/nav/widgets/widgets.dart';
...
class NavScreen extends StatelessWidget {
  ...
  void _selectedBottomNavItem(BuildContext context, BottomNavItem selectedItem, bool isSameItem) {
    if (isSameItem) {
  ...
  Widget _buildOffStageNavigator(BottomNavItem currentItem, bool isSelected) {
    return Offstage(offstage: !isSelected, child: TabNavigator(navigatorKey: navigatorKeys[currentItem], item: currentItem),);
  }
}
